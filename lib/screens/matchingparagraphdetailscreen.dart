...
class MatchingParagraphsDetailScreen extends StatefulWidget {
  ...
  _MatchingParagraphsDetailScreenState createState() =>
      _MatchingParagraphsDetailScreenState(reading);
}

class _MatchingParagraphsDetailScreenState
    extends State<MatchingParagraphsDetailScreen> {
  final MatchingParagraphs reading;
  _MatchingParagraphsDetailScreenState(this.reading);
...
// Containers for Ending Questions
                        ListView.builder(
                          shrinkWrap: true,
                          physics: const NeverScrollableScrollPhysics(),
...
class CustomPopupDialog extends StatelessWidget {
        ...
        ElevatedButton(
          onPressed: () {
            ...
            if (reading.answers != null) {
              openBookingDetailsSheet(context, reading as MatchingParagraphs);
            } else {
  ...
  void openBookingDetailsSheet(
      BuildContext context, MatchingParagraphs reading) {
